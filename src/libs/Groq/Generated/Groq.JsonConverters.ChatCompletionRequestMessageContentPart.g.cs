...
namespace Groq.JsonConverters
{
    ...
    public class ChatCompletionRequestMessageContentPartJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Groq.ChatCompletionRequestMessageContentPart>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score2 = 0;
            if (__jsonProps.Contains("document")) __score2++;
            if (__jsonProps.Contains("document.data")) __score2++;
            if (__jsonProps.Contains("document.id")) __score2++;
            ...
            global::Groq.ChatCompletionRequestMessageContentPartDocument? documentContentPart = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
