...
namespace Groq
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Groq.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Groq.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Groq.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Groq.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Groq.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Groq.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Groq.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Groq.ApiException exception)
        ...
        private static global::Groq.AutoSDKRequestOptions CloneRequestOptions(
            global::Groq.AutoSDKRequestOptions? source)
        {
            var clone = new global::Groq.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
