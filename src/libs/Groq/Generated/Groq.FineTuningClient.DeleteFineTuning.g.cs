...
namespace Groq
{
    public partial class FineTuningClient
    {
        ...
        partial void PrepareDeleteFineTuningArguments(
            ...
            ref string id);
        partial void PrepareDeleteFineTuningRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessDeleteFineTuningResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteFineTuningResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Groq.DeleteFineTuningResponse> DeleteFineTuningAsync(
            string id,
            global::Groq.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteFineTuningAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Groq.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Groq.AutoSDKHttpResponse<global::Groq.DeleteFineTuningResponse>> DeleteFineTuningAsResponseAsync(
            string id,
            global::Groq.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteFineTuningArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Groq.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Groq.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteFineTuningAsync",
                                pathTemplate: "$\"/v1/fine_tunings/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteFineTuningResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Groq.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteFineTuningResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Groq.DeleteFineTuningResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Groq.AutoSDKHttpResponse<global::Groq.DeleteFineTuningResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Groq.DeleteFineTuningResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
