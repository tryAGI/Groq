...
namespace Groq
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Groq.AutoSDKRetryOptions Retry { get; set; } = new global::Groq.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Groq.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Groq.IAutoSDKHook>();
        ...
        public global::Groq.AutoSDKClientOptions AddHook(
            global::Groq.IAutoSDKHook hook)
        {
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Groq.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    public sealed class AutoSDKAuthorizationProviderHook : global::Groq.AutoSDKHook
    {
            ...
            global::Groq.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Groq.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Groq.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Groq.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Groq.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Groq.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Groq.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::Groq.AutoSDKHookContext CreateHookContext(
            ...
            global::Groq.AutoSDKClientOptions clientOptions,
            global::Groq.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Groq.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Groq.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Groq.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Groq.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Groq.IAutoSDKHook, global::Groq.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Groq.AutoSDKHookContext context)
        {
